...
coho.models <- function ()
{
  ...
  S.stock.sex.week <- list(formula = ~stock + sex + stat.week)
  S.sex.state.week <- list(formula = ~stock + stratum + stat.week)
...
coho.models <- function ()
{
  ...
  Psi.sex.state.tostate <- list(formula = ~sex + stratum + tostratum)
  Psi.week.state.tostate <- list(formula = ~stat.week + stratum + tostratum)
  
  ### quad
  Psi.stock.state.tostate.sex <- list(formula = ~stock + stratum + tostratum + sex)
