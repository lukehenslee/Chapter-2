...
coho.mod.avg.S <- model.average(coho.results, 'S')
coho.mod.avg.S

coho.mod.avg.p <- model.average(coho.results, 'p')

coho.mod.avg.Psi <- model.average(coho.results, 'Psi', drop = F)
coho.mod.avg.Psi
